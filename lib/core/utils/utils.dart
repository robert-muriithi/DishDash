...
String mapFailureToMessage(Failure failure) {
  switch (failure.runtimeType) {
    ...
    case DatabaseFailure: DatabaseFailure databaseFailure = failure as DatabaseFailure;
...
extension SavedFoodModelExtension on SavedFoodModel {
  String? getSavedFoodIngredient(int index) {
    switch (index) {
      case 1:
        return strIngredient1;
      case 2:
